package com.sparta.security0531.security.provider;
...
//formloginfilter가 인증에 필요한 정보를 클래스로 만들어 security에 인증요청함
//Security는 filter가 요청한 인증처리를 할 provider를 찾음
//실제 인증처리는 provider에서 진행됨
//이 프로바이더가 db에 있는 정보와 맞는지 인증함
